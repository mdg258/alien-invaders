...
DEFENSE_LINE = 100
# the points of the defensive line the ship is protecting
LINE_POINTS = [0,DEFENSE_LINE,GAME_WIDTH,DEFENSE_LINE]

TOP_LINE_POINTS = [0, 620, GAME_WIDTH,620]
...
# The alternate images to use in the filmstrip
ALIEN_SPRITE   = ('alien-strip1.png','alien-strip2.png','alien-strip3.png')
